      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-12 lg:py-20">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="order-2 lg:order-1 animate-slide-up">
            ...
            <p className="text-xl sm:text-2xl font-semibold text-forest-600 italic mb-6 font-serif">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-6 py-3.5 bg-white text-forest-800 font-semibold rounded-xl border-2 border-forest-200 hover:border-forest-400 hover:bg-forest-50 active:scale-95 transition-all duration-200"
              >
                Over Ons
              </button>
            </div>
